...
public class LhzxHttpClientUtil {
    ...
    public static void main(String[] args) {
        ...
        String user = "zjgbdx";//分配的接口调用用户帐号 username
        String siid = "ZJGBDSDX";//客户编号  yoursiid
        String secretKey = "zjgbdx12!@";// 用户接口密钥
        ...
        String mobile = "15609274348,18598103510,15570052578";//群发用英文逗号分隔133xxxxbbbb,135xxxxbbbb
